...
const MAIN = [
  ...
  { id:23, status:"Reach",        row:"US-Based",               ladder:"AI Policy",            kanban:"todo",       salary:"$107.5K–$154.5K",    salaryMin:107500, role:"Global Government Engagement Lead",                 company:"Partnership on AI", loc:"Remote (US or Canada)",              url:"https://ats.rippling.com/pai-job-board/jobs/a3edd066-77de-407a-b607-c7da429cd483",                note:"Masters/7+ yrs required and multi-jurisdiction senior government relationship track record is the real wall — campaign work doesn't substitute. Native Spanish and dual citizenship are genuine assets for international convening. CAD range converts to roughly $80K–$116K USD, well below the US band." },
  { id:24, status:"Reach",        row:"US-Based",               ladder:"Government Affairs",   kanban:"todo",       salary:"$100.2K–$186.2K",    salaryMin:100200, role:"Communications Lead, Public Affairs",               company:"Lockheed Martin",   loc:"Bethesda, MD / Arlington, VA (hybrid)", url:"https://lockheedmartin.eightfold.ai/careers/job/996476696848",                                   note:"5+ yrs of titled comms/PR experience is the base req and you have none — campaign and 'war room' work is named preferred, not the core qualification. Poli-sci degree and political campaign background are unusually direct textual matches to named preferred quals. Heavy multi-team internal coordination on shallow, fast-turnaround requests — flagged fit risk independent of odds. Posted range spans $86K on one grade, likely banded across levels; treat the top as aspirational." },
  { id:25, status:"Qualified",    row:"US-Based",               ladder:"Government Affairs",   kanban:"todo",       salary:"$125K–$160K+bonus",  salaryMin:125000, role:"Manager, External Affairs, West Region",            company:"Clearway Energy Group", loc:"San Francisco (hybrid)",         url:"https://job-boards.greenhouse.io/clearwayjobs/jobs/5030650007",                                   note:"Campaign work sits directly inside the posting's own qualifying-experience list. Solid CA-specific political relationships is the real gap — a required 'bring' item, not preferred. Coalition-building among diverse stakeholders and bilingual Spanish are genuine assets. Posting explicitly invites candidates below 100% match; smaller, less competitive pool than the OpenAI GCA Manager role with the same gap." },
  { id:26, status:"Qualified",    row:"US-Based",               ladder:"Government Affairs",   kanban:"todo",       salary:"Not disclosed",      salaryMin:0,      role:"Advocacy Coordinator",                              company:"Kino Border Initiative", loc:"Nogales, AZ (hybrid — 3 days/wk in Nogales, Sonora, MX)", url:"https://diocesetucson.org/human-resources/employment-opportunities/?gnk=job&gni=8a78859f9fd3baa001a001b634163a31&lang=en", note:"Poli-sci degree, LATAM Studies minor, and fluent Spanish are all named directly in the required qualifications — the strongest textual match in the tracker. Role requires being an active member of a faith community; a priest reference (former parochial vicar, KoC chaplain) is the real answer to that, not a guess. Comp is undisclosed and estimated well under the $80K floor — confirm before investing time." },
  { id:27, status:"Qualified",    row:"US-Based",               ladder:"Product/Project Mgmt", kanban:"todo",       salary:"$53.2K–$86.5K",      salaryMin:53185,  role:"Jury Specialist",                                   company:"U.S. District Court, District of Oregon", loc:"Portland, OR",           url:"",                                                                                                note:"No real gate — HS diploma plus 1 yr admin/clerical experience is the bar, cleared easily. Actual work is dense, procedural, high-interrupt juror-facing coordination (JMS/IVR systems, summons processing, trial-calendar logistics) — the shape of work flagged as a poor fit independent of odds. Excepted Service, at-will, no promotion potential. Be ready to explain why this is the target given a policy/advocacy-leaning resume." },
